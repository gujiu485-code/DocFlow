...
export function DocumentOutline({ contentJson }: DocumentOutlineProps) {
  const outline = getDocumentOutline(contentJson);

  return (
    <aside className="hidden h-screen w-56 shrink-0 border-l bg-background px-4 py-20 xl:block">
