...
import { getKnowledgeIndexChunkCount, type KnowledgeIndexStore } from "@/lib/knowledge-base";
        ...
        <div
          className={cn(
            ...
            expanded
              ...
              : "max-h-0 opacity-0 group-hover:mt-2 group-hover:max-h-40 group-hover:opacity-100 group-focus-within:mt-2 group-focus-within:max-h-40 group-focus-within:opacity-100",
          )}
        >
          <textarea
            value={draftQuestion}
